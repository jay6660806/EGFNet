...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/root/lanyun-tmp/ultralytics-yolo11-main/runs/train/exp36/weights/best.pt', help='trained weights path')
    parser.add_argument('--batch', type=int, default=64, help='total batch size for all GPUs')
