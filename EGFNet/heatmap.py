...
def get_params():
    params = {
        'weight': '/root/lanyun-tmp/ultralytics-yolo11-main/runs/train/exp25/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/root/lanyun-tmp/fuben/datasets/NEU-DET/test/images/scratches_298.jpg', 'yolo11to4')
