...
if __name__ == '__main__':
    ...
    parser.add_argument('--base-weights', type=str, default='/root/lanyun-tmp/ultralytics-yolo11-main/runs/prune/yolov11-prune39/weights/model_c2f_v2.pt', help='base weights path')
    parser.add_argument('--prune-weights', type=str, default='/root/lanyun-tmp/ultralytics-yolo11-main/runs/prune/yolov11-finetune10/weights/best.pt', help='prune weights path')
    ...
    plt.title('Channel comparison diagram', fontdict={'fontsize':20})
    plt.tight_layout()
